  ...
  (html
    ...
    [:body
      [:div {:class "container"}
        ...
        [:p "Once you have leiningen installed, you can initialize a new app with " [:b "lein new app clojure-web-tutorial"]]
        ...
        (link-to {:class "btn btn-primary"} "/pages/2" "Next page >")]]))
    ...
    [:body
      [:div {:class "container"}
        ...
        [:p "With Clojure, we can avoid the use of HTML files at all by leveraging the Hiccup library.  In this tutorial you'll
              see how HTML files can be genrated by functions within the same logic as the server.  It allows you to do more flexible
        ...
        [:p "To get a basic web endpoint set up, first require the Ring and Compojure in the :dependencies vector in project.clj:"]
  ...
  (html
    ...
    [:body
      [:div {:class "container"}
        ...
        (link-to {:class "btn btn-primary"} "/pages/2" "< Previous page")
  ...
  (html
    ...
    [:body
      [:div {:class "container"}
        ...
        [:p "You can see how it's used in the source code for this page: "]
        ...
        [:p "In this file, we can see how tags are structured.  Each tag is a vector where the first element is the tag name in
                :keyword form.  The next parameter, which is optional, is a map with settings for the tag.  For example to recreate
                the HTML paragraph tag with class='paragraph', you would use " [:b "[:p {:class \"paragraph\"} \"MyParagraph\"]"] "."]

        [:p "Check out the entire source code for this page below.  You can see we also use hiccup's (link-to ... ) function
                to create links."]


        (link-to {:class "btn btn-primary"} "/pages/3" "< Previous page")
    ...
    [:body
      [:div {:class "container"}
        ...
        [:p "We can then use bootstrap to give our page body some style by putting all our content in a
            <div class='container'> tag with the clojure vector "
            [:b "[:div {:class \"container\"}]"]
            ".  For more information
            on how to style your page with bootstrap, you can go here.
  ...
  (html
    ...
    [:body
      [:div {:class "container"}
        ...
        [:p "project.clj"
          [:p "https://github.com/jholkeboer/clojure-web-tutorial/blob/master/project.clj"]]

        [:p "core.clj"
          [:p "https://github.com/jholkeboer/clojure-web-tutorial/blob/master/src/clojure_web_tutorial/core.clj"]]

        [:p "pages.clj"
          [:p "https://github.com/jholkeboer/clojure-web-tutorial/blob/master/src/clojure_web_tutorial/pages.clj"]]
