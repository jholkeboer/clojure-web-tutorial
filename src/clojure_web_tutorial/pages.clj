    ...
    [:body
      [:div {:class "container"}
        ...
        [:p "To install Leiningen on a Mac you can use Homebrew with "
            ...
            setups you can go " (link-to "http://leiningen.org" "here") "."]
  ...
  (html
    ...
    [:body
      [:div {:class "container"}
        ...
        [:p (link-to {:class "btn btn-primary"} "/pages/1" "< Previous page")
  ...
  (html
    ...
    [:body
      [:div {:class "container"}
        ...
        [:p "<script src=\"https://gist.github.com/jholkeboer/2f553861612ea1eed8eace34a531a3b9.js\"></script>"]
  ...
  (html
    ...
    [:body
      [:div {:class "container"}
        ...
        [:p "<script src=\"https://gist.github.com/jholkeboer/9a320425d19f7a0261af7b862008fe31.js\"></script>"]

        [:p "In the file below, we can see how tags are structured.  Each tag is a vector where the first element is the tag name in
        ...
        [:p "You can use this format to create deeply nested html structures.
            ...
            to create links.  The first argument to link-to is the url and the second is the text that will be displayed.
            At the end of the function, you can see where each page's page number is used to choose a page function."]
